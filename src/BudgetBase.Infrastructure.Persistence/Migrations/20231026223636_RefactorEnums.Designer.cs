...
namespace BudgetBase.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20231026223636_RefactorEnums")]
    partial class RefactorEnums
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BudgetBase.Core.Domain.Entities.Enum", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BudgetBase.Core.Domain.Entities.Transaction", b =>
                {
                    ...
                    b.HasOne("BudgetBase.Core.Domain.Entities.Enum", "TransactionEntryType")
                        .WithMany("Transactions")
            ...
            modelBuilder.Entity("BudgetBase.Core.Domain.Entities.TransactionCategory", b =>
                {
                    ...
                    b.HasOne("BudgetBase.Core.Domain.Entities.Enum", "TransactionType")
                        .WithMany("Categories")
